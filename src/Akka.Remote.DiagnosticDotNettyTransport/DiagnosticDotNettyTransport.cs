//-----------------------------------------------------------------------
// <copyright file="DiagnosticDotNettyTransport.cs" company="Akka.NET Project">
...
namespace Akka.Remote.DiagnosticDotNettyTransport
{
    ...
    {
        protected readonly DiagnosticDotNettyTransport Transport;
        protected readonly ILoggingAdapter Log;

        protected CommonHandlers(DiagnosticDotNettyTransport transport, ILoggingAdapter log)
        {
            Transport = transport;
            Log = log;
        }
        ...
        {
            var localAddress = DiagnosticDotNettyTransport.MapSocketToAddress((IPEndPoint)channel.LocalAddress, Transport.SchemeIdentifier, Transport.System.Name, Transport.Settings.Hostname);
    ...
    internal abstract class DiagnosticDotNettyTransport : Transport.Transport
    {
        ...
        protected DiagnosticDotNettyTransport(ActorSystem system, Config config)
        {
            System = system;
            Config = config;
