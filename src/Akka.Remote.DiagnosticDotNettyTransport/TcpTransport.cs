...
namespace Akka.Remote.DiagnosticDotNettyTransport
{
    public abstract class TcpHandlers : CommonHandlers
    {
        ...
        protected TcpHandlers(Remote.DiagnosticDotNettyTransport.DiagnosticDotNettyTransport transport, ILoggingAdapter log) : base(transport, log)
        {
        }
    ...
    internal sealed class TcpServerHandler : TcpHandlers
    {
        ...
        public TcpServerHandler(Remote.DiagnosticDotNettyTransport.DiagnosticDotNettyTransport transport, ILoggingAdapter log, Task<IAssociationEventListener> associationEventListener) 
            : base(transport, log)
        {
        ...
        void InitInbound(IChannel channel, IPEndPoint socketAddress, object msg)
        {
            ...
            _associationEventListener.ContinueWith(r =>
            {
                ...
                var remoteAddress = Remote.DiagnosticDotNettyTransport.DiagnosticDotNettyTransport.MapSocketToAddress(
    ...
    internal sealed class TcpClientHandler : TcpHandlers
    {
        ...
        public TcpClientHandler(Remote.DiagnosticDotNettyTransport.DiagnosticDotNettyTransport transport, ILoggingAdapter log, Address remoteAddress) 
            : base(transport, log)
        {
    ...
    internal sealed class TcpAssociationHandle : AssociationHandle
    {
        ...
        public TcpAssociationHandle(Address localAddress, Address remoteAddress, Remote.DiagnosticDotNettyTransport.DiagnosticDotNettyTransport transport, IChannel channel)
    ...
    internal sealed class TcpTransport : DiagnosticDotNettyTransport
    {
